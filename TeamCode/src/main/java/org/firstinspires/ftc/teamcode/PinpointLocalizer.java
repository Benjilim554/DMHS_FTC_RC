...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 750.1678940084392; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 418.67403995534386; // x position of the perpendicular encoder (in tick units)
    }
