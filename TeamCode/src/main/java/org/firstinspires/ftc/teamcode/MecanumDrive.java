...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 124.5 / 54494;
        public double lateralInPerTick = 0.0016943423501342859;
        public double trackWidthTicks = 6568.678277147958;

        // feedforward parameters (in tick units)
        public double kS = 1.690373570078831;
        public double kV = 0.0002742467710153887;
        public double kA = 0.00011;

        // path profile parameters (in inches)
        public double maxWheelVel = 95;
        public double minProfileAccel = -61;
        public double maxProfileAccel = 95;
